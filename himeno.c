...
#pragma xmp align wrk1[i][j][k] with t(k, j, i)
#pragma xmp align wrk2[i][j][k] with t(k, j, i)
#pragma xmp align a[*][i][j][k] with t(k, j, i)
#pragma xmp align b[*][i][j][k] with t(k, j, i)
#pragma xmp align c[*][i][j][k] with t(k, j, i)
